...
const Header = () => {
  return (
    <div className="w-full flex justify-between items-center bg-[#eee] lg:!px-9 p-2 lg:p-2 gap-2 shadow-md">
      <div className="w-full  justify-around flex min-[1537px]:max-w-[80%] gap-2">
        <div className="flex flex-grow gap-5 lg:gap-16 w-full lg:max-w-[80%]">
          <Logo />
          <SearchBar />
        </div>
